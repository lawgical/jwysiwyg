 ...
 (function($)
 {
    ...
    $.extend(Wysiwyg.prototype, {
        ...
        initFrame: function()
        {
            ...
            $(this.editorDoc).keydown(function(event)
            {
                ...
                // backspace
                {
                    ...
                    if (self.emptyContentRegex.test(content)) {
                        // if content is empty
                        event.stopPropagation();
                        // prevent remove single empty tag
                        return false;
                    }
                }
                return true;
            ...
            if (this.options.autoGrow)
            {
                ...
                $(this.editorDoc).find('body').css('border', '1px solid white');
                // cancel margin collapsing
        ...
        grow: function()
        {
            ...
            var innerHeight = $.browser.msie ? innerBody[0].scrollHeight: innerBody.height() + 2 + 20;
            ...
            this.editor.attr('scrolling', height < this.options.maxHeight ? 'no': 'auto');
            // hide scrollbar firefox
            innerBody.css('overflow', height < this.options.maxHeight ? 'hidden': '');
